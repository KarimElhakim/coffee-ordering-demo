...
import { DEMO_MENU_ITEMS, DEMO_STORES, DEMO_STATIONS } from './demo-menu-items.js';

// Seed data
const DEMO_STORE = DEMO_STORES[0];
...
// Old items removed - now using real Starbucks data from demo-menu-items.ts
